...
describe('/page-one', () => {
    ...
    it('should create a book with correct input data', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, supertest_1.default)(src_1.app)
            .get('/page-one')
            .expect(src_1.HTTP_STATUSES.OK_200, [createdBookOne]);
    }));
    ...
    it('create one more book with correct data', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, supertest_1.default)(src_1.app)
            .get('/page-one')
            .expect(src_1.HTTP_STATUSES.OK_200, [createdBookOne, createdBookTwo]);
    }));
    ...
    it('should update a book with correct input data', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, supertest_1.default)(src_1.app)
            .get(`/page-one/` + createdBookOne.id)
            .expect(src_1.HTTP_STATUSES.OK_200, Object.assign(Object.assign({}, createdBookOne), { title: data.title }));
        yield (0, supertest_1.default)(src_1.app)
            .get(`/page-one/` + createdBookTwo.id)
            .expect(src_1.HTTP_STATUSES.OK_200, createdBookTwo);
    }));
