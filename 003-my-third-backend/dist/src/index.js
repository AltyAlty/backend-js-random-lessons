...
на запрос.*/
exports.app.get('/page-one', (req, res) => {
...
exports.app.get('/page-one/:id', (req, res) => {
...
/*C - Create*/
exports.app.post('/page-one', (req, res) => {
    if (!req.body.title) {
...
/*D - Delete*/
exports.app.delete('/page-one/:id', (req, res) => {
...
/*U - Update*/
exports.app.put('/page-one/:id', (req, res) => {
    if (!req.body.title) {
        res.sendStatus(exports.HTTP_STATUSES.BAD_REQUEST_400);
        return;
    }
