...
Библиотека bcrypt используем для создания hash-соли. Для установки библиотеки используем: yarn add bcrypt. Для установки
типов для этой библиотеки используем: yarn add -D @types/bcrypt
